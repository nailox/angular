...
export class BookServiceProxy {
    ...
    getBooks(maxResultCount: number, skipCount: number, userId: number): Observable<GetBooksOutput> {
        ...
        return this.http.request(url_, {
            ...
            return this.processGetBooks(response);
        }).catch((response: any, caught: any) => {
            if (response instanceof Response) {
                try {
                    return Observable.of(this.processGetBooks(response));
                } catch (e) {
     ...
     * @return Success
     */
    updateBook(input: UpdateBookInput): Observable<void> {
        ...
        return this.http.request(url_, {
            ...
            return this.processUpdateBook(response);
        }).catch((response: any, caught: any) => {
            if (response instanceof Response) {
                try {
                    return Observable.of(this.processUpdateBook(response));
                } catch (e) {
                    return <Observable<void>><any>Observable.throw(e);
                }
            } else
    ...
    protected processUpdateBook(response: Response): void {
        const responseText = response.text();
        const status = response.status; 
    ...
    deleteBook(bookId: number): Observable<void> {
        ...
        return this.http.request(url_, {
            ...
            return this.processDeleteBook(response);
        }).catch((response: any, caught: any) => {
            if (response instanceof Response) {
                try {
                    return Observable.of(this.processDeleteBook(response));
                } catch (e) {
                    return <Observable<void>><any>Observable.throw(e);
                }
            } else
    ...
    protected processDeleteBook(response: Response): void {
        const responseText = response.text();
        const status = response.status; 
